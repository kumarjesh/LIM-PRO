      ...
      <div className="card">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8, marginBottom: 14 }}>
          {PRESETS.map((ml) => {
            ...
            return (
              ...
              >
                {ml}
                <span style={{ fontSize: 9, opacity: 0.6 }}>ml</span>
              </button>
            );
          })}
        </div>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 6 }}>
          <input
            ...
            style={{
              flex: 1,
              background: customMl ? "rgba(34,211,238,0.06)" : "rgba(255,255,255,0.05)",
        ...
        {customError && (
          <div style={{ fontSize: 11, color: "#f87171", marginBottom: 10 }}>⚠ {customError}</div>
        )}
        ...
        {isValid && (
          <div style={{
            ...
            Calculating for{" "}
            <span style={{ color: "#22d3ee", fontWeight: 700 }}>{selectedMl}ml</span>
          </div>
        )}
        ...
        <button
          ...
          onClick={isValid ? onAnalyze : undefined}
          disabled={!isValid}
        >
