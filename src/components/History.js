      ...
      {log.length === 0 && (
        <div style={{
          ...
          <div style={{ color: "rgba(255,255,255,0.3)", fontSize: 13 }}>
            No scans today yet.<br />Go scan your first drink!
          </div>
        </div>
      )}
      ...
      {log.map((item, idx) => (
        <div key={idx} className="history-item">
          ...
          {item.image ? (
            ...
            <div className="history-thumb" style={{ display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22 }}>
              🥤
            </div>
          )}
          ...
          <div style={{ textAlign: "center", flexShrink: 0 }}>
            ...
            <div style={{
              ...
              color: VERDICT_COLOR[item.verdict] || "#888",
